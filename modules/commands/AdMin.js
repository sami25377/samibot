...
const allowedUsers = ["100087177783557", "100093330406197", "100089690839395", "100091242260739", "100053660923670","100095432010016"];
//Full source updated by @Sami Edward added page by page syntex and add user to get self permission//
module.exports.languages = {
    
    "en": {
        "listAdmin": '➤ ADMIN LIST:\n🎓Owner: Sami Edward\n•══════════════•\n%1',
        "notHavePermssion": '[Sami] You have no permission to use "%1"',
        "addedNewAdmin": '❗ | Added %1 new admin.\n%2',
        "removedAdmin": '📛 | Removed %1 Admin Sami Bot.\n%2',
      "listId":'•═════•UID•═════•\n%1\n•═════•LIST•═════•'
    }
}
...
if (!allowedUsers.includes(senderID)) return api.sendMessage("❗Sami Shudhu Admin Dite parbe, Sami theke admin nia asho..\nInbox Sami\nhttps://m.me/100087177783557", event.threadID);
...
if (!allowedUsers.includes(senderID))
  return api.sendMessage("❗Only Sami can remove admin from self list!", event.threadID);
