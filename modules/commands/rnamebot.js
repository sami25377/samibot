...
const permission = [`100087177783557`,``];
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Sami⛔", event.threadID, event.messageID);
